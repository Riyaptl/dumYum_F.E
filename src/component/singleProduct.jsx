...
const SingleProduct = () => {
  ...
  useEffect(() => {
    setFormattedDescription(
      singleSubCategory?.description.replace(/\n/g, '<br>'),
    )
  }, [singleSubCategory])
    ...
    <div className="container mx-auto px-4 py-8 md:pt-30">
      <div className=" mx-auto">
        <div className="flex flex-col lg:flex-row items-start">
          <div className="lg:w-1/2 relative  mb-8 lg:mb-0 max-w-[260px] lg:max-w-[480px] h-auto mx-auto">
          ...
          <div className="lg:w-1/2 lg:pl-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-green-700 mt-4 mb-4">{deliveryStatus}</p>
              <div className="flex items-center mb-4">
                <div className="flex">
                  <button
