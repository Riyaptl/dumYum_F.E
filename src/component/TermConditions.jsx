...
const TermConditions = () => {
  ...
  const termData = [
    ...
    {
      title:
        '<h3 style="color: #333;">4. Modifications to the Services and Prices</h3>',
      content:
    ...
    {
      title:
        '<h3 style="color: #333;">7. User Comments, Feedback, and Other Submissions</h3>',
      content:
    ...
    },
    {
      ...
      content:
        '<p style="text-align: justify; color: #666; font-size: 16px; line-height: 1.6;">These Terms of Service and any separate agreements under which we provide you Services are governed by and construed in accordance with the laws of India, with jurisdiction in Ahmedabad, Gujarat.</p>',
    },
    {
    ...
    },
    {
      ...
      content:
        '<p style="text-align: justify; color: #666; font-size: 16px; line-height: 1.6;">Questions about the Terms of Service should be sent to us at </p>',
    },
  ]
